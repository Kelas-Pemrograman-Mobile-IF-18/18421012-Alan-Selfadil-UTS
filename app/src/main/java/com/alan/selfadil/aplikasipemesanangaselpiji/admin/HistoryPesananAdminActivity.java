...
import com.alan.selfadil.aplikasipemesanangaselpiji.user.EditdanHapusDataGasActivity;
...
public class HistoryPesananAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsList.clear();
        adapter = new AdapterGas(HistoryPesananAdminActivity.this, newsList);
    ...
    public void onBackPressed() {
        Intent i = new Intent(HistoryPesananAdminActivity.this, UserActivity.class);
        startActivity(i);
        finish();
    }
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (status == false) {
                                Log.d("data gas = ", response.toString());
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent a = new Intent(HistoryPesananAdminActivity.this, EditdanHapusDataGasActivity.class);
